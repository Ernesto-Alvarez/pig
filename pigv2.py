...
#####
##### 
##### TO SELECT THE INTERFACE TO SNIFF ON, EDIT pigv2/sensors.py LINE 27 ######
#####
#####
...
sensor = ethernet_sensor(sensor_queue.put)
...
protocol_id_sensor = l3_protocol_sensor(protocol_id_queue.put)
...
ip_s1 = ip_local_bcast_sensor(ip_sensor_queue.put)
ip_s2 = ip_local_multicast_sensor(ip_sensor_queue.put)
ip_s3 = ip_directed_bcast_sensor(ip_sensor_queue.put)
ip_s4 = arp_sensor(ip_sensor_queue.put)
...
uip_sensor = ip_sensor(uip_sensor_queue.put)
